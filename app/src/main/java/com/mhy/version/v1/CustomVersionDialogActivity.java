...
import com.mhy.version.R;
import com.mhy.versionlib.core.VersionDialogActivity;
import com.mhy.versionlib.callback.APKDownloadListener;
import com.mhy.versionlib.callback.DialogDismissListener;
import com.mhy.versionlib.callback.CommitClickListener;
...
//        Log.e("CustomVersionDialogActi", "正在下载中回调...");
    ...
    public void showLoadingDialog(int currentProgress) {
        if (!isCustomDownloading) {
            ...
            ProgressBar pb = (ProgressBar) loadingView.findViewById(com.mhy.versionlib.R.id.pb);
            TextView tvProgress = (TextView) loadingView.findViewById(com.mhy.versionlib.R.id.tv_progress);
            tvProgress.setText(String.format(getString(com.mhy.versionlib.R.string.versionchecklib_progress), currentProgress));
